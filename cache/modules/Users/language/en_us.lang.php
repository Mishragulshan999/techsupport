...
If you are not setting up Inbound Email, please clear all fields in that section.',
  ...
  'LBL_CURRENCY_CREATE_IN_PREFERRED_TEXT' => 'Revenue Line Items added to an Opportunitie from the Product Catalog will be converted to the user’s preferred Currency if it differs from the Currency used in the Product Catalog item.',
