...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='name_basic' >{sugar_translate label='LBL_NAME' module='ReportMaker'}</label>
    	</td>
