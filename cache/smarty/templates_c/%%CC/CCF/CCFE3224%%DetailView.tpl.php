...
<?php else: ?>
<td>&nbsp;</td><td>&nbsp;</td>
<?php endif;  if ($this->_tpl_vars['fields']['license_type']['acl'] > 0):  echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['license_type']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>

<span id="license_type" class="sugar_field"><?php echo $this->_tpl_vars['LICENSE_TYPE_READONLY']; ?>
</span>
<?php endif; ?>
</td>
<?php else: ?>
...
<?php ob_start(); ?>
<tr>
<?php if ($this->_tpl_vars['fields']['business_center_name']['acl'] > 0):  echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['business_center_name']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<?php if (! empty ( $this->_tpl_vars['fields']['business_center_id']['value'] )): ?></a><?php endif;  endif; ?>
</td>
<?php else: ?>
<td>&nbsp;</td><td>&nbsp;</td>
...
<tr>
<td scope="row"><slot><?php echo ((is_array($_tmp=$this->_tpl_vars['MOD']['LBL_SEND_EMAIL_ON_MENTION'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:</slot></td>
<td><slot><input class="checkbox" type="checkbox" disabled <?php echo $this->_tpl_vars['SEND_EMAIL_ON_MENTION']; ?>
></slot></td>
<td><slot><?php echo $this->_tpl_vars['MOD']['LBL_SEND_EMAIL_ON_MENTION_TEXT']; ?>
&nbsp;</slot></td>
</tr>
<tr>
