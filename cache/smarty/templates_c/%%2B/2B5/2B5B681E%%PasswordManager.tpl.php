...
'
                            ...
                            <tr>
                                <td width='25%' scope="row" valign='top'
                                    nowrap><?php echo $this->_tpl_vars['MOD']['LBL_LDAP_ENCRYPTION_TYPE']; ?>
 <?php echo smarty_function_sugar_help(array('text' => $this->_tpl_vars['MOD']['LBL_LDAP_ENCRYPTION_TYPE_DESC']), $this);?>

                                </td>
                                <td width='25%' align="left" valign='top'>
                                    <select tabindex='2' id="ldap_encryption" name="ldap_encryption">
                                        <?php echo $this->_tpl_vars['LDAP_ENCRYPTION_TYPE_OPTIONS']; ?>
