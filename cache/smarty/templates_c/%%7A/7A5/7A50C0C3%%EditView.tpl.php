<?php /* Smarty version 2.6.11, created on 2022-02-17 15:20:01
         compiled from modules/Configurator/tpls/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_csrf_form_token', 'modules/Configurator/tpls/EditView.tpl', 26, false),array('function', 'sugar_help', 'modules/Configurator/tpls/EditView.tpl', 50, false),array('function', 'sugar_getimage', 'modules/Configurator/tpls/EditView.tpl', 482, false),)), $this); ?>
<?php echo '
<style>
...
<span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
        ...
        <td width="35%" >
           <?php if (! empty ( $this->_tpl_vars['settings']['proxy_password'] )): ?>
               <input type="password" id="proxy_password" name="proxy_password" size="25"  disabled tabindex="1" style="display: none">
               <a href="javascript:void(0)" id="proxy_password_link" onClick="SUGAR.util.setEmailPasswordEdit('proxy_password')"><?php echo $this->_tpl_vars['APP']['LBL_CHANGE_PASSWORD']; ?>
</a>
           <?php else: ?>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
	<tr>
    <th align="left" scope="row" colspan="4"><h4><?php echo $this->_tpl_vars['MOD']['LBL_DIALOUT_TITLE']; ?>
</h4></th>
	</tr>
	<tr>
    <td width="25%" scope="row" valign='middle'><?php echo $this->_tpl_vars['MOD']['LBL_DIALOUT_ON']; ?>
&nbsp<?php echo smarty_function_sugar_help(array('text' => $this->_tpl_vars['MOD']['LBL_DIALOUT_ON_DESC'],'WIDTH' => 400), $this);?>
</td>
...
<?php if ($this->_tpl_vars['SHOW_CATALOG_CONFIG']): ?>
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
    <tr>
        <th align="left" scope="row" colspan="4"><h4><?php echo $this->_tpl_vars['MOD']['LBL_SUGAR_CATALOG_SETTINGS']; ?>
</h4></th>
    </tr>
	<tr>
		<td width="25%" scope="row"><?php echo $this->_tpl_vars['MOD']['LBL_SUGAR_CATALOG_ENABLED']; ?>
</td>
		<?php if (! empty ( $this->_tpl_vars['config']['catalog_enabled'] )): ?>
			<?php $this->assign('catalogChecked', 'CHECKED'); ?>
		<?php else: ?>
			<?php $this->assign('catalogChecked', ''); ?>
		<?php endif; ?>
		<td><input type='hidden' name='catalog_enabled' value='false'><input name='catalog_enabled'  type="checkbox" value='true' <?php echo $this->_tpl_vars['catalogChecked']; ?>
></td>
	</tr>
	<tr>
		<td width="25%" scope="row"><?php echo $this->_tpl_vars['MOD']['LBL_SUGAR_CATALOG_URL']; ?>
</td>
		<td><input style="width:40%" name="catalog_url" value="<?php echo $this->_tpl_vars['config']['catalog_url']; ?>
"></td>
	</tr>
</table>
<?php endif; ?>
