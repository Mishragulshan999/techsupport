...
?>
                ...
                temp_array['name'] = '<?php echo ((is_array($_tmp=$this->_tpl_vars['secondary_field']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
';
