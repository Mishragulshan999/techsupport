<?php /* Smarty version 2.6.11, created on 2022-02-07 16:53:39
         compiled from modules/EmailMan/tpls/config.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'modules/EmailMan/tpls/config.tpl', 15, false),array('function', 'sugar_csrf_form_token', 'modules/EmailMan/tpls/config.tpl', 36, false),array('function', 'sugar_getimage', 'modules/EmailMan/tpls/config.tpl', 106, false),array('modifier', 'escape', 'modules/EmailMan/tpls/config.tpl', 190, false),)), $this); ?>
...
var authInfo = ';  echo $this->_tpl_vars['js_authinfo'];  echo '
-->
</script>
'; ?>
...
">
    ...
    <input type="hidden" name="eapm_id" id="eapm_id" value="<?php echo $this->_tpl_vars['eapm_id']; ?>
" />
    <input type="hidden" name="authorized_account" id="authorized_account" value="<?php echo $this->_tpl_vars['authorized_account']; ?>
" />
    <input type="hidden" name="mail_authtype" id="mail_authtype" value="<?php echo $this->_tpl_vars['mail_authtype']; ?>
" />
...
" class="button primary" onclick="this.form.action.value='Save';return save_data(this);" type="submit" name="button" id="btn_save" value=" <?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
 ">
        ...
        <tr>
            <td colspan="4">
                <div id="smtpButtonGroup" class="yui-buttongroup">
                    <span id="google_oauth2" class="yui-button yui-radio-button<?php if ($this->_tpl_vars['mail_smtptype'] == 'google_oauth2'): ?> yui-button-checked<?php endif; ?>">
                        <span class="first-child">
                            <button type="button" name="mail_smtptype" value="google_oauth2">
                                &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['APP']['LBL_SMTPTYPE_GOOGLE_OAUTH2']; ?>
&nbsp;&nbsp;&nbsp;&nbsp;
                            </button>
                        </span>
                    </span>
                    <span id="exchange_online" class="yui-button yui-radio-button<?php if ($this->_tpl_vars['mail_smtptype'] == 'exchange_online'): ?> yui-button-checked<?php endif; ?>">
                        <span class="first-child">
                            <button type="button" name="mail_smtptype" value="exchange_online">
                                &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['APP']['LBL_SMTPTYPE_EXCHANGE_ONLINE']; ?>
&nbsp;&nbsp;&nbsp;&nbsp;
                            </button>
                        </span>
                    </span>
                    <span id="yahoomail" class="yui-button yui-radio-button<?php if ($this->_tpl_vars['mail_smtptype'] == 'yahoomail'): ?> yui-button-checked<?php endif; ?>">
                        <span class="first-child">
                            <button type="button" name="mail_smtptype" value="yahoomail">
                                <?php echo smarty_function_sugar_getimage(array('alt' => $this->_tpl_vars['mod_strings']['LBL_YAHOO_MAIL_LOGO'],'name' => 'yahoomail_logo','ext' => ".png",'other_attributes' => ''), $this);?>
                    ...
                    <span id="exchange" class="yui-button yui-radio-button<?php if ($this->_tpl_vars['mail_smtptype'] == 'exchange'): ?> yui-button-checked<?php endif; ?>">
                        <span class="first-child">
                            <button type="button" name="mail_smtptype" value="exchange">
                                <?php echo smarty_function_sugar_getimage(array('alt' => $this->_tpl_vars['mod_strings']['LBL_EXCHANGE_LOGO'],'name' => 'exchange_logo','ext' => ".png",'other_attributes' => ''), $this);?>
                    ...
                    <span id="gmail" class="yui-button yui-radio-button<?php if ($this->_tpl_vars['mail_smtptype'] == 'gmail'): ?> yui-button-checked<?php endif; ?>">
                        <span class="first-child">
                            <button type="button" name="mail_smtptype" value="gmail">
                                <?php echo smarty_function_sugar_getimage(array('alt' => $this->_tpl_vars['mod_strings']['LBL_GMAIL_LOGO'],'name' => 'gmail_logo','ext' => ".png",'other_attributes' => ''), $this);?>
...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr id="auth_block" style="display:none">
            <td colspan="4">
                ...
                <button type="button" id="auth_button" name="auth_button" style="padding:5px;margin:10px 2px" onclick="authorize();"><?php echo $this->_tpl_vars['APP']['LBL_EMAIL_AUTHORIZE']; ?>
</button>
            </td>
        </tr>
		<tr>
			<td colspan="4">
			     <div id="smtp_settings">
					<table width="100%" cellpadding="0" cellspacing="0">
                        <tr id="mailsettings0">
                            <td width="20%" scope="row"><span id="auth_status_label"><?php echo $this->_tpl_vars['MOD']['LBL_AUTH_STATUS']; ?>
</span></td>
                            <td width="30%" ><input type="text" id="auth_status" name="auth_status" tabindex="1" size="25" maxlength="64" value="<?php if (! empty ( $this->_tpl_vars['eapm_id'] )):  echo $this->_tpl_vars['APP']['LBL_EMAIL_AUTHORIZED'];  endif;  if (empty ( $this->_tpl_vars['eapm_id'] )):  echo $this->_tpl_vars['APP']['LBL_EMAIL_NOT_AUTHORIZED'];  endif; ?>" disabled></td>
                            <td width="20%" scope="row"><span id="auth_email_label"><?php echo $this->_tpl_vars['MOD']['LBL_AUTHORIZED_ACCOUNT']; ?>
</span></td>
                            <td width="30%" ><input type="text" id="auth_email" name="auth_email" size="25" maxlength="64" value="<?php echo $this->_tpl_vars['authorized_account']; ?>
...
" tabindex='1' ></td>
                       ...
                       <tr id="smtp_auth2">
                            ...
                            <td width="30%" >
                            <input type="password" id="mail_smtppass" name="mail_smtppass" size="25" <?php if (! empty ( $this->_tpl_vars['PASSWORD_MAX_LENGTH'] )): ?>maxlength="<?php echo $this->_tpl_vars['PASSWORD_MAX_LENGTH']; ?>
" <?php endif; ?>tabindex='1' autocomplete="off">
...
<div style="padding-top:2px;">
			<input title="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_TITLE']; ?>
" class="button primary" onclick="this.form.action.value='Save';return save_data(this);" type="submit" name="button" value=" <?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
 ">
			<input title="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_TITLE']; ?>
" class="button" onclick="this.form.action.value='<?php echo $this->_tpl_vars['RETURN_ACTION']; ?>
'; this.form.module.value='<?php echo $this->_tpl_vars['RETURN_MODULE']; ?>
...
function testOutboundSettings() {
    ...
    if(authType === \'oauth2\' && (trim(eapmId) === \'\' || trim(authAccount) === \'\')) {
        errorMessage = "';  echo $this->_tpl_vars['APP']['LBL_EMAIL_PLEASE_AUTHORIZE_TESTING'];  echo '" + "<br/>";
        overlay("';  echo $this->_tpl_vars['APP']['LBL_EMAIL_ACCOUNT_NOT_AUTHORIZED'];  echo '", errorMessage, \'alert\');
        return false;
    }
    if(trim(smtpServer) == \'\') {
        isError = true;
...
function handleOauthComplete(e) {
    ...
    if (data.eapmId && data.emailAddress && data.userName) {
        ...
        document.getElementById(\'auth_status\').value = \'';  echo $this->_tpl_vars['APP']['LBL_EMAIL_AUTHORIZED'];  echo '\';
        ...
        alert(\'';  echo $this->_tpl_vars['APP']['LBL_EMAIL_AUTH_FAILURE'];  echo '\');
    }
...
function save_data(form) {
    ...
    if(authType === \'oauth2\' && (trim(eapmId) === \'\' || trim(authAccount) === \'\')) {
        errorMessage = "';  echo $this->_tpl_vars['APP']['LBL_EMAIL_PLEASE_AUTHORIZE'];  echo '";
        alert(errorMessage);
        return false;
    }
...
var handleOauth2TabSwitch = function(smtptype, defaults) {
	...
	document.getElementById(\'auth_status\').value = authInfo[smtptype][\'eapm_id\'] ?
			\'';  echo $this->_tpl_vars['APP']['LBL_EMAIL_AUTHORIZED'];  echo '\' : \'';  echo $this->_tpl_vars['APP']['LBL_EMAIL_NOT_AUTHORIZED'];  echo '\';
}
...
document.getElementById(\'EditView\').mail_smtptype.value = "';  echo $this->_tpl_vars['mail_smtptype'];  echo '";
