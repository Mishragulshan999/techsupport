...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugarvar', 'include/SugarFields/Fields/Base/EditView.tpl', 13, false),array('modifier', 'default', 'include/SugarFields/Fields/Base/EditView.tpl', 19, false),array('modifier', 'escape', 'include/SugarFields/Fields/Base/EditView.tpl', 21, false),)), $this); ?>
{*
/*
...
'<?php endif; ?> 
    value='{$value}' title='<?php echo ((is_array($_tmp=$this->_tpl_vars['vardef']['help'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hexentity') : smarty_modifier_escape($_tmp, 'hexentity')); ?>
