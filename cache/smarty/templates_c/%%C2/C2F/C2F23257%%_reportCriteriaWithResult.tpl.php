...
">
<input type="hidden" id="report_name" name="report_name" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['reportName'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'UTF-8') : smarty_modifier_escape($_tmp, 'html', 'UTF-8')); ?>
">
...
:</b> <?php echo ((is_array($_tmp=$this->_tpl_vars['reportName'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'UTF-8') : smarty_modifier_escape($_tmp, 'html', 'UTF-8')); ?>
...
:</b> <?php echo ((is_array($_tmp=$this->_tpl_vars['reportAssignedToName'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'UTF-8') : smarty_modifier_escape($_tmp, 'html', 'UTF-8')); ?>
